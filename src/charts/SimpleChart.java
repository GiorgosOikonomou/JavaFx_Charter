    ...
    @Override public void init() throws Exception {
        ...
        events = FXCollections.observableArrayList(
                new Event("Javelin", "6 6", FXCollections.observableArrayList(
                        createSeries("Javelin - Tokyo", FXCollections.<Number>observableArrayList(18, 20, 22)),
                        createSeries("Javelin - Kyoto", FXCollections.<Number>observableArrayList(23, 14, 15))
                )),
                new Event("Hammer", "12 2 2 12", FXCollections.observableArrayList(
                        createSeries("Hammer - Tokyo", FXCollections.<Number>observableArrayList(12, 11, 5)),
                        createSeries("Hammer - Kyoto", FXCollections.<Number>observableArrayList(9, 8, 13))
                )),
                new Event("Shotput", "", FXCollections.observableArrayList(
                        createSeries("Shotput - Tokyo", FXCollections.<Number>observableArrayList(3, 2, 4)),
                        createSeries("Shotput - Kyoto", FXCollections.<Number>observableArrayList(4, 6, 5))
                ))
        );
